...
#define TL_LEFT_MARGIN          80
#define TL_UP_MARGIN            25
#define TL_WIDTH                960
#define CH_WIDTH                80
#define NUM_15SEC_PER_MIN       12
#define NUM_MIN_PER_HOUR        20
...
void TimeLine::paintBorder(QPainter *painter)
{
    ...
    {
        QRect bar(TL_LEFT_MARGIN-2, TL_UP_MARGIN + (i * TL_HEIGHT), TL_WIDTH+4,  32);
