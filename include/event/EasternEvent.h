...
enum SendQTEvent {
    ...
    Send_QT_SYSTEM_LOG_COUNT,
    Send_QT_SYSTEM_LOG_DATA,
    Send_QT_SYSTEM_LOG_BACKUP,
...
typedef enum {
    ...
    EVENT_LOG_OCCUR_TRIGGER5,
    EVENT_LOG_OCCUR_TRIGGER6,
    EVENT_LOG_OCCUR_TRIGGER7,
    EVENT_LOG_OCCUR_TRIGGER8,
...
typedef enum {
    ...
    SYSTEM_LOG_DATA,
    SYSTEM_LOG_BACKUP,
    SYSTEM_LOG_DELETE_ALL,
} SYSTEM_LOG_E;

typedef enum {
    SYSTEM_LOG_TYPE_ALL = 0,
    SYSTEM_LOG_TYPE_FLASH,
    SYSTEM_LOG_TYPE_EVENT,
    SYSTEM_LOG_TYPE_MAX,
} SYSTEM_LOG_TYPE_E;
